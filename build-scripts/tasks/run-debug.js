...
gulp.task('launch', function () {
    ...
    var options = {
        script: '../debug/server.js', //../debug/server.js
        ext: 'ejs js',
        ignore: ['**/*'],
        stdout: true
    };
...
gulp.task('launch-zendesk', function () {

    var options = {
        // script: 'zat server -p ../debug', //../debug/server.js
        // ext: 'ejs js',
        // ignore: ['**/*'],
        exec: "zat server -p ../debug",
        stdout: true
    };
...
gulp.task('run-debug', ['run-build'], function () {
    gulp.start('launch-zendesk', 'watch'); // gulp.start('launch', 'watch');
});